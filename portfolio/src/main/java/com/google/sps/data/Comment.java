...
public class Comment {
  ...
  public Comment(Entity entity) {
    ...
    final float sentimentScore =
        sentimentScoreEntity == null ? 0 : sentimentScoreEntity.floatValue();
    final float sentimentMagnitude =
        sentimentMagnitudeValue == null ? 0 : sentimentMagnitudeValue.floatValue();
